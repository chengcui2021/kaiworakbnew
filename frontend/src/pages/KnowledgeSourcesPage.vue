...
const { ingestGitHub } = useIngestionService()
  ...
  <div class="mx-auto flex w-full max-w-5xl flex-col gap-6 p-6">
    <div>
      ...
      <p class="mt-1 text-sm text-muted-foreground">
        Snapshot governed source material and create reviewable candidate knowledge. Ingestion never auto-approves knowledge.
      </p>
    </div>
